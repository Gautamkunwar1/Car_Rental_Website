...
function PartnerBanner():JSX.Element {
    return (
        <>
            ...
            <div className='flex flex-wrap lg:flex-nowrap justify-center lg:justify-around items-center mx-auto w-[95%] lg:w-[90%] rounded-lg shadow-2xl m-2 opacity-75 mt-5  bg-blue-200 py-4 gap-4'>
