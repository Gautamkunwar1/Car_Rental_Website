...
function Login(): JSX.Element {
    ...
    async function handleSubmit(e: FormEvent): Promise<void> {
        ...
        if(result.role ==="user"){
            console.log("Logged in with role",result.role);
            navigate("/")
    ...
    return (
        <div className="bg-[url(src/assets/blueCar.jpg)] bg-center bg-no-repeat bg-cover flex justify-center items-center h-[70vh]">
            <form
                className="flex justify-center items-center h-[80%] w-[40%] bg-[#20202063] border-1 shadow-2xl text-white"
            ...
            >
                <div className="w-full p-7 mb-5 mt-5">
                    ...
                    <input
                        ...
                        className="bg-white p-1.5 w-full mb-2 outline-0 text-black"
                        value={userEmail}
                    ...
                    <div className="flex justify-between items-center pr-4 mb-2 bg-white">
                        ...
                        />
                        <span
                            className="text-gray-500 cursor-pointer opacity-50 ml-2"
